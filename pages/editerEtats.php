<?php
   require_once('identifier.php');
    ...
    $requete="select * from etats where idEta=$idf";
    $resultat=$pdo->query($requete);
    $filiere=$resultat->fetch();
    $nomf=$filiere['libelleEta'];
        ...
        <div class="container">
             ...
             <div class="panel panel-primary margetop60">
                ...
                <div class="panel-body">
                    <form method="post" action="updateEtats.php" class="form">
                        ...
                        <div class="form-group">
                             <label for="libelleEta">Nom de la filière:</label>
